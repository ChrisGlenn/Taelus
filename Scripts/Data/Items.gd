...
var items = {
	...
	"Rags" : {"finder": "RAG","name": "Cloth Rags","description": "Some old ragged clothing","frame" : 257,"weight" : 1,"value" : 2,"amnt" : 1,"max_amnt" : 1,"min_amnt" : 1,"stackable" : false,"equip": true,"equipped": false,"equip_slot": "Armor","type" : "EQUIP","hud_mode" : "return","func_one" : [0],"func_two" : [0],"func_three" : [0]}
}